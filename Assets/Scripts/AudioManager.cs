...
public class AudioManager{
    ...
    public enum IDs {Select, PlaceNote, PlaceBuilding, Erase, Undo, Redo, ClearPuzzle, VictoryCheer, GotCoins, ClickedTutorial, SpendCoins, MenuButton, ExpandButton, ContractButton}
